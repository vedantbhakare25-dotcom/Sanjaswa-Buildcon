...
function ContactHeroOverlay({ isVisible, onDismiss }) {
            ...
            {contentReady && (
              ...
              >
                ...
                <motion.p
                  ...
                  {...fadeUp(0.7)}
                >
                  Great, Let&rsquo;s Crack a Deal
                </motion.p>
                <motion.div
...
export default ContactHeroOverlay;